...
export function Calendar({disabledCalendar, formData, setFormData, formRef, navButtons = 'on', ...props}) {
               ...
               <div className="flex justify-between items-center  text-gray-600 mb-3">
                  <span
                     className={`material-icons h-7 w-7 pt-[2px] text-center rounded 
                        ${calendarConfig[navButtons].navButtonsClasses}`}
                     onClick={() => navButtons == 'on' && datesHandler.handleChangeMonth('previous')}
                  >chevron_left
                  </span>
                  ...
                  <span
                     className={`material-icons h-7 w-7 pt-[2px] text-center rounded 
                        ${calendarConfig[navButtons].navButtonsClasses}`}
                     onClick={() => navButtons == 'on' &&  datesHandler.handleChangeMonth('next')}
                  >chevron_right
                  </span>
               </div>
                  ...
                  {currentCalendar?.lastDaysOfPreviousMonth.map(day => (
                     <span
                        ...
                        className={`h-8 leading-8 rounded-[3px] text-[14px] text-center 
                           ${calendarConfig[navButtons].calendarNextAndPrevDaysClasses}`}
                        onClick={() => {
                           if(navButtons == 'on'){
