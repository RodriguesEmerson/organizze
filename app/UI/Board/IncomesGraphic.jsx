...
export function IncomesGraphic() {
   ...
   const { getIncomesData, incomesGraphicConfig } = useIncomesGraphic();
   ...
   return (
      <div className="p-1 pr-2 w-[300px] bg-white shadow-md rounded-md overflow-hidden">
         <div className="flex items-center justify-center text-white text-xs w-[105%] -ml-1 -mt-1 mb-1 bg-green-800 h-8">
            <h2>Receitas por Categoria</h2>
         </div>
         <canvas ref={chartRef} width="300" height="300" className=""></canvas>
      </div>
   )
}